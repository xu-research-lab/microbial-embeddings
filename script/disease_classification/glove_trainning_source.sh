...
#SBATCH -n 28                 # 使用28核
#SBATCH --mem=250G  
#SBATCH -o master_%a_m.log  # 改动点
#SBATCH -e master_%a_m.err  # 改动点
#SBATCH --array=1-8%3
#SBATCH --exclude=cu01
...
# 读取参数矩阵
mapfile -t params < matrix_newdata_source.txt # 改动点
...
SOURCE_DIR="p80_abundance_percentile_1"  # 复用模式时源目录
BASE_DIR="."           # 输出基准目录
INPUT_BIOM="${BASE_DIR}/table_permutation_version3.biom"  # TODO 输入文件路径
